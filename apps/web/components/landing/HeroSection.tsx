...
export default function HeroSection({
  ...
  return (
    <section className="relative overflow-hidden bg-[#fbf5ed] lg:min-h-[820px]">
      ...
      <div className="absolute inset-y-0 right-0 z-0 hidden w-[60%] overflow-hidden lg:block">
        <Image
        ...
        {/* Soft transition between text and illustration */}
        <div
          aria-hidden="true"
          className="absolute inset-y-0 left-0 w-[22%] bg-gradient-to-r from-[#fbf5ed] via-[#fbf5ed]/55 to-transparent"
        />

        {/* Slight warm wash so the image stays in the HearKind palette */}
        <div
          aria-hidden="true"
      ...
      <div className="relative z-30">
        <Header
          onWaitlistClick={() =>
            onWaitlistClick("header")
          }
        />
      </div>

      <div className="relative z-10 mx-auto max-w-7xl px-6 pb-36 pt-16 sm:pb-40 lg:grid lg:grid-cols-[40%_60%] lg:pb-44">
        <div className="relative z-10 mx-auto max-w-2xl lg:mx-0 lg:max-w-[510px] lg:pr-5">
          <p className="mb-8 text-xs font-semibold uppercase tracking-[0.24em] text-[#c66f4b] sm:tracking-[0.35em]">
            Anonymous peer support
          </p>

          <h1 className="text-5xl font-semibold leading-[0.95] tracking-tight sm:text-6xl lg:text-[68px] xl:text-7xl">
            Find someone who truly understands
          </h1>

          <p className="mt-7 max-w-xl text-lg leading-8 text-[#6f6254] lg:max-w-[430px]">
            Connect with someone who&apos;s been through a
            similar life challenge — outside your social
            circle, anonymously, and without the pressure
            of social media.
          </p>
        ...
        {/* Empty desktop grid column because the image is a background */}
        <div className="hidden lg:block" />

        {/* Mobile and tablet illustration */}
